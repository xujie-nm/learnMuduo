#ifndef LEARNMUDUO_CHAPTER7_CDNS_RESOLVER_H
#define LEARNMUDUO_CHAPTER7_CDNS_RESOLVER_H
...
namespace cdns{
    class Resolver : boost::noncopyable{
        public:
            typedef boost::function<void(const std::vector<muduo::net::InetAddress>&)> Callback;
            enum Option{
                kDNSandHostsFile,
                kDNSonly,
            };
